...
(function () {
  ...
  var DICT = {
    ...
    'ca.w.similar_compare': { ko: '유사 종목 비교', en: 'Compare Similar' },
    'ca.w.daily_trades':    { ko: '일자별 거래량',   en: 'Daily Volume' },
    'ca.w.ai_question':     { ko: 'AI Analysis',     en: 'AI Analysis' },
    'ca.w.ai_analysis':     { ko: 'AI Analysis',     en: 'AI Analysis' },
    'ca.ai_question':       { ko: 'AI Analysis',     en: 'AI Analysis' },
    'ca.ai_analysis':       { ko: 'AI Analysis',     en: 'AI Analysis' },
